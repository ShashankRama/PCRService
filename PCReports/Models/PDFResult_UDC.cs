namespace PCReports.Models.UDC
{
    public class PDFResult
    {
        ...
        public string VerticalFrameProfile { get; set; }
        public string TopFrameProfile { get; set; }
        public string BottomFrameProfile { get; set; }
        public string VerticalSashBarProfile { get; set; }
        public string HorizontalSashBarProfile { get; set; }
        public double VerticalFrameProfileWeight { get; set; }
        public double TopFrameProfileWeight { get; set; }
        public double BottomFrameProfileWeight { get; set; }
        public double VerticalSashBarProfileWeight { get; set; }
        public double HorizontalSashBarProfileWeight { get; set; }
